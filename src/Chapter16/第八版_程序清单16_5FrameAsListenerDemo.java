...
public class 第八版_程序清单16_5FrameAsListenerDemo extends JFrame implements ActionListener{
	...
	public 第八版_程序清单16_5FrameAsListenerDemo(){
	...
	public static void main(String[] args){
		JFrame frame = new 第八版_程序清单16_5FrameAsListenerDemo();
